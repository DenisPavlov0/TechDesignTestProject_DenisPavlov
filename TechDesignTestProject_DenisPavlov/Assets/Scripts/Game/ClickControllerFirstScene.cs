...
public class ClickControllerFirstScene : MonoBehaviour
{
    [Header("Animator")]
            ...
            if (hit)
            {
                switch (hit.collider.tag)
                {
                    ...
                    case GlobalConstants.DOOR_TAG:
                        ...
                        break;
                    case GlobalConstants.CHARACTER_TAG:
                        AudioController.instance.PlaySoundEffect(AudioController.instance.character_voice);
                        break;
                    default:
                        break;
                }
